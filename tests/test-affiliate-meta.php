...
class Affiliate_Meta_Tests extends WP_UnitTestCase {
	...
	function test_add_metadata() {
		$this->assertFalse( affwp_add_affiliate_meta() );
	...
	function test_update_metadata() {
		$this->assertFalse( affwp_update_affiliate_meta() );
		$this->assertFalse( affwp_update_affiliate_meta( $this->_affiliate_id ) );
	...
	function test_get_metadata() {
		$this->assertFalse( affwp_get_affiliate_meta( $this->_affiliate_id ) );
		$this->assertFalse( affwp_get_affiliate_meta( $this->_affiliate_id ), 'key_that_does_not_exist', true );
