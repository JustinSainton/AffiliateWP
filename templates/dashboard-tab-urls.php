<div id="affwp-affiliate-dashboard-url-generator" class="affwp-tab-content">
	...
	<p><?php printf( __( 'Your referral URL is: <strong>%s</strong>', 'affiliate-wp' ), affwp_get_affiliate_referral_url() ); ?></p>
	...
	<form id="affwp-generate-ref-url" class="affwp-form" method="get" action="#affwp-generate-ref-url">
		...
		<div class="affwp-referral-url-submit-wrap">
			<input type="hidden" id="affwp-referral-format" value="<?php echo esc_attr( affwp_get_referral_format() ); ?>" />
			<input type="hidden" id="affwp-referral_pretty_urls" value="<?php echo affwp_is_pretty_referral_urls(); ?>" />
