...
class AffWP_Visits_Table extends WP_List_Table {
	...
	function column_affiliate( $visit ) {
		return '<a href="' . admin_url( 'admin.php?page=affiliate-wp-visits&affiliate=' . $visit->affiliate_id ) . '">' . affiliate_wp()->affiliates->get_affiliate_name( $visit->affiliate_id ) . '</a>';
	}
