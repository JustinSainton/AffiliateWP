	...
	<form method="post" id="affwp_review_affiliate">
		...
		<table class="form-table">
			...
			<tr class="form-row form-required">
				...
				<td>
					<a title="<?php _e( 'Affiliate\'s Website URL', 'affiliate-wp' ); ?>" href="<?php echo esc_url( $user_url ); ?>" target="blank"><?php echo esc_url( $user_url ); ?></a>
				</td>
			...
			<tr class="form-row form-required">
				...
				<td>
					<?php echo esc_attr( $promotion_method ); ?>
				</td>
		...
		<?php
			echo '<a class="button button-primary" href="' . add_query_arg( array( 'affwp_notice' => 'affiliate_accepted', 'action' => 'accept', 'affiliate_id' => $affiliate_id ) ) . '">' . __( 'Accept Affiliate', 'affiliate-wp' ) . '</a>';
			echo '<a class="button button-secondary" href="' . add_query_arg( array( 'affwp_notice' => 'affiliate_rejected', 'action' => 'reject', 'affiliate_id' => $affiliate_id ) ) . '">' . __( 'Reject Affiliate', 'affiliate-wp' ) . '</a>';
		?>
	</form>
